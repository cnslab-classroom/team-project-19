...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class MarkwonLibraryAccessors extends SubDependencyFactory {
        private final MarkwonSyntaxLibraryAccessors laccForMarkwonSyntaxLibraryAccessors = new MarkwonSyntaxLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>markwon.syntax</b>
         */
        public MarkwonSyntaxLibraryAccessors getSyntax() {
            return laccForMarkwonSyntaxLibraryAccessors;
        }

    }

    public static class MarkwonSyntaxLibraryAccessors extends SubDependencyFactory {

        public MarkwonSyntaxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>highlight</b> with <b>io.noties.markwon:syntax-highlight</b> coordinates and
         * with version reference <b>markwon</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getHighlight() {
            return create("markwon.syntax.highlight");
        }
